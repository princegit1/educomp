    ...
    <div class="col-md-8 col-sm-6 col-xs-12">
      <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="heading_inner_page marbtm20"> Video Gallery</div>
            ...
            <div class="row">
              ...
              <div class="col-md-10 col-xs-12">
                <div class="photo_video_slider_container">
                          ...
                          <div class="photo_video_slider1"> <img src="images/slider-1.jpg" alt="image" class="wphsl">
                            <div class="bk_shd">
                              <div class="left_icon_area">
                                <div class="img_icon"> <img src="images/video_icon.jpg" alt="imgicon"></div>
                  ...
                  <div class="photo_video_thumbnail_cnt marbtm20">
                    <div class="row">
                      <div class="col-md-4 col-sm-4 martb20">
                        <div class="main_bx_pv">
                          <div class="ph_vd_cont_bx">
                            ...
                            <div class="cmvd_icon"> <img src="images/video_sm.jpg" alt="camera"> 10 </div>
                          </div>
